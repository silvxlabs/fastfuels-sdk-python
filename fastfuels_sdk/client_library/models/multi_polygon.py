...
class MultiPolygon(BaseModel):
    ...
    MultiPolygon
    """ # noqa: E501
    type: Optional[StrictStr] = 'MultiPolygon'
    coordinates: List[List[List[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=2, max_length=3)]]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'MultiPolygon',
