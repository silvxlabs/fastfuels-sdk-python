...
from ..models.topography_band import TopographyBand
...
T = TypeVar("T", bound="CreateThreeDepTopographyRequest")


@_attrs_define
class CreateThreeDepTopographyRequest:
    ...
    To change the *output* cell size, set ``alignment.resolution`` instead.
        ...
        Attributes:
            ...
            source_resolution (ThreeDepResolution | Unset): Available resolutions for 3DEP data (meters).
            bands (list[TopographyBand] | Unset):
    """
    ...
    source_resolution: ThreeDepResolution | Unset = UNSET
    bands: list[TopographyBand] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        source_resolution: int | Unset = UNSET
        if not isinstance(self.source_resolution, Unset):
            source_resolution = self.source_resolution.value
        ...
        if source_resolution is not UNSET:
            field_dict["source_resolution"] = source_resolution
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        _source_resolution = d.pop("source_resolution", UNSET)
        source_resolution: ThreeDepResolution | Unset
        if isinstance(_source_resolution, Unset):
            source_resolution = UNSET
        else:
            source_resolution = ThreeDepResolution(_source_resolution)
        ...
        if _bands is not UNSET:
            ...
            for bands_item_data in _bands:
                bands_item = TopographyBand(bands_item_data)

                bands.append(bands_item)

        create_three_dep_topography_request = cls(
            name=name,
        ...
        create_three_dep_topography_request.additional_properties = d
