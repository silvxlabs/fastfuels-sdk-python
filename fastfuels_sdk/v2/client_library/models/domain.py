...
class Domain:
    ...
    Attributes:
        ...
        id (str | Unset): A unique identifier for the domain.
        created_on (datetime.datetime | None | Unset): The date and time the domain was created.
        modified_on (datetime.datetime | None | Unset): The date and time the domain was last modified.
    """
