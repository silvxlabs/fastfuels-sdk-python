...
T = TypeVar("T", bound="GridModificationCondition")


@_attrs_define
class GridModificationCondition:
    """Attribute-based condition for grid modifications.

    Uses dot-notation band keys (e.g., "fuel_load.1hr", "fbfm").

        Attributes:
            band (str): The band to check (dot-notation key)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grid_modification_condition = cls(
            band=band,
            operator=operator,
            value=value,
        )

        grid_modification_condition.additional_properties = d
