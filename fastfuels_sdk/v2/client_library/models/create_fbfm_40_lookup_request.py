...
from ..models.fbfm_40_lookup_band import Fbfm40LookupBand
...
T = TypeVar("T", bound="CreateFbfm40LookupRequest")


@_attrs_define
class CreateFbfm40LookupRequest:
    ...
    because derived grids carry the same domain reference as their source.
        ...
        Attributes:
            source_grid_id (str): Grid containing FBFM40 codes
            bands (list[Fbfm40LookupBand]):
            source_band (str | Unset): Band in source grid containing FBFM codes Default: 'fbfm'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for bands_item_data in _bands:
            bands_item = Fbfm40LookupBand(bands_item_data)
        ...
        create_fbfm_40_lookup_request = cls(
            source_grid_id=source_grid_id,
            bands=bands,
        ...
        create_fbfm_40_lookup_request.additional_properties = d
        return create_fbfm_40_lookup_request
