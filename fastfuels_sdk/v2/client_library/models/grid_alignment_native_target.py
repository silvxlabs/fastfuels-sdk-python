...
T = TypeVar("T", bound="GridAlignmentNativeTarget")


@_attrs_define
class GridAlignmentNativeTarget:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if target != "native":
            raise ValueError(f"target must match const 'native', got '{target}'")
        ...
        grid_alignment_native_target = cls(
            target=target,
            resolution=resolution,
            method=method,
        )

        grid_alignment_native_target.additional_properties = d
        return grid_alignment_native_target
