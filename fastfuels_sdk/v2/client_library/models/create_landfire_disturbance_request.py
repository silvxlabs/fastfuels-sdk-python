...
from ..models.landfire_disturbance_version import LandfireDisturbanceVersion
...
T = TypeVar("T", bound="CreateLandfireDisturbanceRequest")


@_attrs_define
class CreateLandfireDisturbanceRequest:
    ...
    fetched on demand from LANDFIRE Product Service.
        ...
        Attributes:
            ...
            version (LandfireDisturbanceVersion | Unset):
    """
    ...
    version: LandfireDisturbanceVersion | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_version, Unset):
            ...
            version = LandfireDisturbanceVersion(_version)

        create_landfire_disturbance_request = cls(
            name=name,
        ...
        create_landfire_disturbance_request.additional_properties = d
        return create_landfire_disturbance_request
