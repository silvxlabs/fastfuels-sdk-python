...
T = TypeVar("T", bound="FeatureGeoreference")


@_attrs_define
class FeatureGeoreference:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feature_georeference = cls(
            crs=crs,
            bounds=bounds,
        )

        feature_georeference.additional_properties = d
        return feature_georeference
