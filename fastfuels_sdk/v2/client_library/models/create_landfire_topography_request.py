...
from ..models.landfire_topography_version import LandfireTopographyVersion
...
@_attrs_define
class CreateLandfireTopographyRequest:
    ...
    slope (degrees), and/or aspect (degrees).
        ...
        Attributes:
            ...
            version (LandfireTopographyVersion | Unset): Available LANDFIRE topography data versions.
    ...
    version: LandfireTopographyVersion | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        version: LandfireTopographyVersion | Unset
        if isinstance(_version, Unset):
            version = UNSET
        else:
            version = LandfireTopographyVersion(_version)
        ...
        create_landfire_topography_request = cls(
            name=name,
        ...
        create_landfire_topography_request.additional_properties = d
        return create_landfire_topography_request
