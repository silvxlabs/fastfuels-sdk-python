...
from ..models.meta_chm_version import MetaCHMVersion
...
T = TypeVar("T", bound="CreateMetaChmRequest")


@_attrs_define
class CreateMetaChmRequest:
    ...
    - chm: Canopy height in meters
        ...
        Attributes:
            ...
            version (MetaCHMVersion | Unset): Available Meta CHM data versions.
    """
    ...
    version: MetaCHMVersion | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        version: MetaCHMVersion | Unset
        if isinstance(_version, Unset):
            version = UNSET
        else:
            version = MetaCHMVersion(_version)

        create_meta_chm_request = cls(
            name=name,
        ...
        create_meta_chm_request.additional_properties = d
