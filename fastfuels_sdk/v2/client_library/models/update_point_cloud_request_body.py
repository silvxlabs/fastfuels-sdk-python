...
T = TypeVar("T", bound="UpdatePointCloudRequestBody")


@_attrs_define
class UpdatePointCloudRequestBody:
    ...
    `checksum`.
        ...
        Attributes:
            ...
            tags (list[str] | None | Unset): New tags (replaces the existing list). Omit to leave unchanged.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_point_cloud_request_body = cls(
            name=name,
            description=description,
            tags=tags,
        )

        update_point_cloud_request_body.additional_properties = d
        return update_point_cloud_request_body
