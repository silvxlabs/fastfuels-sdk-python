...
T = TypeVar("T", bound="InventoryColumnsBiomassSourceComponentStates")
...
class InventoryColumnsBiomassSourceComponentStates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inventory_columns_biomass_source_component_states = cls()
        ...
        inventory_columns_biomass_source_component_states.additional_properties = (
            additional_properties
        )
        return inventory_columns_biomass_source_component_states
