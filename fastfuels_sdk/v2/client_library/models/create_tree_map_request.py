...
from ..models.tree_map_band import TreeMapBand
from ..models.tree_map_version import TreeMapVersion
...
T = TypeVar("T", bound="CreateTreeMapRequest")


@_attrs_define
class CreateTreeMapRequest:
    ...
    - plt_cn: FIA plot condition number (optional, derived from tree table)
        ...
        Attributes:
            ...
            version (TreeMapVersion | Unset): Available TreeMap data versions.
            bands (list[TreeMapBand] | Unset):
    """
    ...
    version: TreeMapVersion | Unset = UNSET
    bands: list[TreeMapBand] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        version: TreeMapVersion | Unset
        if isinstance(_version, Unset):
            version = UNSET
        else:
            version = TreeMapVersion(_version)
        ...
        if _bands is not UNSET:
            ...
            for bands_item_data in _bands:
                bands_item = TreeMapBand(bands_item_data)
        ...
        create_tree_map_request.additional_properties = d
        return create_tree_map_request
